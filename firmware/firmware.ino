...
/*1 const*/ int SERV_R_STOP = 80, SERV_L_STOP = 88, SERV_R_FORW = 180, SERV_L_FORW = 0, SERV_R_BACK = 0, SERV_L_BACK = 180;
      ...
      while (last_char != -1) {
        switch (input_buffer[0]) {
          case '1': //moveTo
            {
              if (is_motor_start) {
                is_distance_test_on = input_buffer.substring(2, 3).toInt(); // On/Off distance test
